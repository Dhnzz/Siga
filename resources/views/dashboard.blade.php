...
<body>
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h3 class="logo me-auto"><a href="index.html">SIGA - Bone Bolango</a></h3>
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Data Terpilah</span> <i
                        ...
                        <ul>
                            ...
                            <li><a href="#">Bidang Hukum</a></li>
                        </ul>
                    </li>
                    <li class="dropdown"><a href="#"><span>Perlindungan Anak</span> <i
                                class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="#">Eksploitasi Anak</a></li>
                            <li class="dropdown"><a href="#"><span>Kekerasan Kepada Anak</span> <i
                                        class="bi bi-chevron-right"></i></a>
                                <ul>
                                    <li><a href="#">Berdasarkan Jenis Kejahatan</a></li>
                                    <li><a href="#">Berdasarkan Tempat Kejadian</a></li>
                                    <li><a href="#">Berdasarkan Lembaga Layanan</a></li>
                                    <li><a href="#">Berdasarkan Sifat Lembaga</a></li>
                                    <li><a href="#">Berdasarkan Jenis Layanan</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li><a class="getstarted scrollto" href="#about">Lihat Data Gender</a></li>
                </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
                    ...
                    <p class="text-white">Data terpilah Gender dan Anak di Kabupaten Bone Bolango memiliki fungsi untuk
                        memotret tingkat keberhasilan pembangunan dan pemberdayaan perempuan, perlindungan perempuan
                        dan anak melalui strategi Pengarusutamaan Gender (PUG) dan Pengarusutamaan Hak Anak (PUHA)</p>
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <a href="#about" class="btn-get-started scrollto"> Lihat Data Gender</a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
                    <img src="assets/img/mother_child.png" width="80%" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
